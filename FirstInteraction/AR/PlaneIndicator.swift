...
class Plane: SCNNode {
    ...
    init(anchor: ARPlaneAnchor, in sceneView: ARSCNView) {
        ...
        let meshGeometry: SCNPlane = SCNPlane(width: CGFloat(anchor.extent.x), height: CGFloat(anchor.extent.z))
        meshNode = SCNNode(geometry: meshGeometry)
        meshNode.simdPosition = anchor.center
